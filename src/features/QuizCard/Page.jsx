...
//   const getNewLevelImages = (images) => {
//     const shuffled = shuffleArray(images);
//     const correct = shuffled.find((img) => img.label === "correct");
//     const wrongs = shuffled.filter((img) => img.label === "wrong").slice(0, 5);
...
//   const POINTS_PER_LEVEL = TOTAL_POINTS / LEVELS;

//   const onAnswerHandle = (selectedPic) => {
//     setSelectedAnswer(selectedPic.label);
//     if (selectedPic.label === "correct") {
...
//       } else {
//         const finalScore =
//           score + (selectedPic.label === "correct" ? POINTS_PER_LEVEL : 0);
...
//                 style={{ width: `${((level - 1) / (LEVELS - 1)) * 100}%` }}
//               ></div>
//             </div>
...
//                           el.label === "correct" ? "animate-bounce" : ""
//                         }`}
//                       >
//                         {el.label === "correct" ? "✓" : "✗"}
//                       </span>
